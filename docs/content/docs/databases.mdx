...
description: 25+ database engines through native Rust drivers, no JDBC dependency.
---

<Callout type="info">
Native Rust drivers, no JDBC dependency. MySQL and PostgreSQL compatible databases work out of the box.
</Callout>
